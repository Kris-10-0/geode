...
public class RedisList extends AbstractRedisData {
  ...
  /**
   * @param start start index of desired elments. Positive index starts at the head. Negative index
   *        starts at the tail.
   * @param stop stop index of desired elments. Positive index starts at the head. Negative index
   *        starts at the tail.
